...
public class MessageObject {
    ...
    public static final int TYPE_GEO = 4;     public static final int TYPE_ROUND_VIDEO = 5;
    ...
    public static final int TYPE_POLL = 17;     public static final int TYPE_GIFT_PREMIUM = 18;
    ...
    public static final int TYPE_JOINED_CHANNEL = 27;     public static final int TYPE_GIVEAWAY_RESULTS = 28;
    public static final int TYPE_PAID_MEDIA = 29;     public static final int TYPE_GIFT_STARS = 30;
    ...
    public static class GroupedMessagePosition {
        ...
        public float top;         public float left;
    ...
    public MessageObject(int accountNum, TLRPC.Message message, MessageObject replyToMessage, AbstractMap<Long, TLRPC.User> users, AbstractMap<Long, TLRPC.Chat> chats, LongSparseArray<TLRPC.User> sUsers, LongSparseArray<TLRPC.Chat> sChats, boolean generateLayout, boolean checkMediaExists, long eid, boolean isRepostPreview, boolean isRepostVideoPreview, boolean isSavedMessages, int searchType) {
        ...
        currentAccount = accountNum;
        messageOwner = message;
        deleted = SharedConfig.isMessageDeleted(getDialogId(messageOwner), messageOwner.id);
    ...
    public void spoilLoginCode() {         if (!spoiledLoginCode && messageText != null && messageOwner != null && messageOwner.entities != null && messageOwner.from_id instanceof TLRPC.TL_peerUser && (messageOwner.from_id.user_id == 777000 || messageOwner.from_id.user_id == UserObject.VERIFY)) {
        ...
        for (int a = 0; a < textRanges.size(); a++) {
            ...
            if (blocksCount == 1) {
                ...
                try {
                    ...
                    block.height = block.textLayout.getHeight();                    block.collapsedHeight = (int) Math.min(paint.getTextSize() * 1.4f * 3, block.height);
                } catch (Exception e) {
                    FileLog.e(e);
                    continue;
                }
    ...
    public boolean hasLinkMediaToMakeSmall() {
        ...
        return hasLinkPreview && !isGiveawayOrGiveawayResults() &&
            ...
            !isSponsored() &&             !"telegram_megagroup".equals(webpageType) &&                 !"telegram_background".equals(webpageType) &&                !"telegram_voicechat".equals(webpageType) &&                 !"telegram_videochat".equals(webpageType) &&
            !"telegram_livestream".equals(webpageType) &&                !"telegram_user".equals(webpageType) &&                      !"telegram_story".equals(webpageType) &&                     !"telegram_channel_boost".equals(webpageType) &&             !"telegram_group_boost".equals(webpageType) &&               !"telegram_chat".equals(webpageType)
        ;
    }
